...
public class GroupService : IGroupService
{
    ...
    {
        var group = new Group { Name = dto.Name, School = dto.School };
        _context.Groups.Add(group);
        await _context.SaveChangesAsync();

        return new GroupDto(group.Id, group.Name, group.School);
    }

    public async Task<List<GroupDto>> GetAllGroupsAsync()
    {
        return await _context.Groups
            .Select(g => new GroupDto(g.Id, g.Name, g.School))
            .ToListAsync();
    }
    ...
    public async Task<GroupDto?> GetGroupByIdAsync(Guid id)
    {
        ...
        return g == null ? null : new GroupDto(g.Id, g.Name, g.School);
    }
}